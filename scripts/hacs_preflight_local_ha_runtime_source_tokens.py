...
LOCAL_HA_RUNTIME_ADDITIONAL_SOURCE_TOKENS = {
    ...
    "custom_components/yeelight_pro/deployment_urls.py": {
        ...
        "api-dev.yeedev.com": "private dev API host push endpoint override",
        "192.168.1.202:7779": "private dev WebSocket endpoint override",
        "api-test.yeedev.com": "private test API host push endpoint override",
        "192.168.0.89:7779": "private test WebSocket endpoint override",
    ...
    "custom_components/yeelight_pro/push_transport_runtime.py": {
        ...
        "payload_shape_summary": "unsupported frame shape diagnostics call",
    ...
    "custom_components/yeelight_pro/push_transport_shapes.py": {
        ...
        "_safe_keys": "unsupported payload shape copies keys only",
        "_NESTED_MAPPING_KEYS": "known private envelope key traversal",
    },
