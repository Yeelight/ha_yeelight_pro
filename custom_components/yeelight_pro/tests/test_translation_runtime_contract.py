...
def test_translations_are_valid_and_key_aligned() -> None:
    ...
    required_paths = {
        ...
        ("services", "debug_dump_push_health", "description"),
        ("services", "debug_emit_push_payload", "description"),
        ("services", "debug_emit_push_payload", "fields", "source_device_id", "name"),
        (
            "services",
        ...
        ("services", "debug_emit_push_payload", "fields", "entity_id", "name"),
        (
            "services",
            "debug_emit_push_payload",
            "fields",
        ...
        ("services", "debug_emit_push_payload", "fields", "node_type", "name"),
        (
            "services",
            "debug_emit_push_payload",
            "fields",
        ...
        ("services", "debug_emit_push_payload", "fields", "payload_shape", "name"),
        (
            "services",
            "debug_emit_push_payload",
            "fields",
        ...
        ("services", "debug_emit_push_payload", "fields", "params", "name"),
        (
            "services",
            "debug_emit_push_payload",
            "fields",
