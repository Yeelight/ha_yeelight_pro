...
def test_iot_registry_contract_check_requires_coverage_tokens(
    ...
    _write_test_file(tests_root / "test_projection_unknown_boundaries.py", "")
    ...
    _write_test_file(tests_root / "test_projection_multi_component_sensors.py", "")
    _write_test_file(tests_root / "test_projection_switch_channels.py", "")
