...
EXPECTED_TEST_FILES = {
    ...
    "test_audit_private_house_coverage.py",
    ...
    "test_runtime_bridge_push_topology_nodes.py",
    "test_runtime_bridge_push_device_aliases.py",
    "test_push_transport_unsupported.py",
    "test_push_transport_private_frames.py",
    "test_push_transport_private_snapshot_state.py",
    "test_push_event_routing.py",
    "test_private_push_broadcast_probe.py",
    "test_private_push_control_echo_probe.py",
    "test_private_push_probe_snapshot.py",
    "test_private_push_probe_topology.py",
    "test_private_house_control_absence.py",
    "test_private_house_coverage_classification.py",
    "test_diagnostics_push_data_status.py",
    "test_diagnostics_push_flow_status.py",
    "test_diagnostic_push_flow.py",
    "diagnostics_push_helpers.py",
    ...
    "test_client_product_schemas.py",
    ...
    "test_push_manager_errors.py",
    "test_push_manager_health.py",
    "test_push_manager_runtime_apply.py",
    ...
    "test_runtime_bridge_scaling.py",
