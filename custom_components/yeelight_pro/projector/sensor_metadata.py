...
from ..entity_category import ENTITY_CATEGORY_DIAGNOSTIC, entity_category_for_property
...
GATEWAY_CONFIG_SENSOR_PROPS = frozenset({"li"})
...
def should_project_registry_sensor(
    ...
    if key in GATEWAY_CONFIG_SENSOR_PROPS and not _is_gateway_component(component):
        return False
    if (
